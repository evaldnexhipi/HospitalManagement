 ...
 */
final class Version20200503203624 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, gender VARCHAR(1) NOT NULL, birthday DATE NOT NULL, address VARCHAR(255) DEFAULT NULL, telephone VARCHAR(15) DEFAULT NULL, is_active TINYINT(1) NOT NULL, token VARCHAR(255) DEFAULT NULL, image_filename VARCHAR(255) DEFAULT NULL, sms_code INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
